...
"""
TOKEN = "491326980:AAEAG7Q0nBiqMSb1Ln7qqdhAGw6_SZJUfMA"
OWMKEY = "574eda874881098922b168aa5c6fefe9"
...
def process_message(bot, u): #This is what we'll do when we get a message 
    ...
    if u.message.sender and u.message.text and u.message.chat: #if it is a text message then get it 
        ...
        print(bot.send_message(chat_id, 'please select an option', reply_markup=reply_markup).wait() )
